...
function Signup(){
    ...
    <div>
        <form onSubmit={handleSubmit}>
            <input type="text" placeholder="First Name*" name="name" className="inpelem" onChange={onNameChange}/> <br/>
            <input type="text" placeholder="Last Name*" name="lastname" className="inpelem" onChange={onNameChange}/> <br/>
            ...
            <button className="btn border border-secondary" style={{"width":"480px","marginTop":"30px","height":"30px","marginLeft":"42px"}}>Proceed</button>
